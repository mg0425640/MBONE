          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 md:p-12 max-w-4xl mx-auto">
            ...
            <div className="bg-white/10 rounded-xl p-6 mb-6">
              <div className="flex items-center justify-center space-x-2 mb-4">
                ...
                <span className="text-white font-bold text-lg">Important Notice</span>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
              <div className="bg-white/5 rounded-xl p-4">
                ...
                <p className="text-white/80">Community Owned</p>
              </div>
              <div className="bg-white/5 rounded-xl p-4">
                <div className="text-2xl font-bold text-brand-accent mb-2">0%</div>
                <p className="text-white/80">Team Allocation</p>
              </div>
              <div className="bg-white/5 rounded-xl p-4">
                <div className="text-2xl font-bold text-brand-accent mb-2">∞</div>
                <p className="text-white/80">Transparency</p>
              </div>
            </div>
