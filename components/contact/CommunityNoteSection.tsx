            ...
            >
              <div className="flex items-start space-x-4">
                <div className="bg-brand-accent/20 w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0">
                  <note.icon className="h-6 w-6 text-brand-accent" />
                </div>
                <div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
            <div className="bg-white/5 rounded-xl p-4">
              ...
              <div className="text-brand-secondary text-sm">DYOR Always</div>
            </div>
            <div className="bg-white/5 rounded-xl p-4">
              <div className="text-brand-primary font-bold mb-1">High Risk Investment</div>
              <div className="text-brand-secondary text-sm">Can Lose Value</div>
            </div>
            <div className="bg-white/5 rounded-xl p-4">
              <div className="text-brand-primary font-bold mb-1">Community Project</div>
              <div className="text-brand-secondary text-sm">Decentralized</div>
            </div>
          </div>
        </motion.div>
      </div>
